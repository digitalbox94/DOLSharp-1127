/*
 *  Instant 20 With Free Gear
 *  
 *  This npc will give you instant 20 only if you do not have a 50 on your account, 
...
namespace DOL.GS
{
    ...
    public class Instant20NPC : GameNPC
    {
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            player.Out.SendMessage("Hello "+player.Name+", I am able to give your character [Instant 20 level].", eChatType.CT_Say, eChatLoc.CL_PopupWindow);
